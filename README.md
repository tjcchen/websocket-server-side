...
This repo is going to cover a basic websocket server side implementation with nodejs from scratch. Unlike those full-fledged projects, ie: [socket.io](https://github.com/socketio/socket.io), [uWebSockets](https://github.com/uNetworking/uWebSockets), [websockets/ws](https://github.com/websockets/ws), this project intends to introduce the core mechanism of websocket for learning and communication purpose.
